...
<div class="wrapper fadeInDown">
    <div id="formContent">
        ...
        <div class="fadeIn first">
            <img src="{{ asset('img/logo.png') }}" id="icon" alt="logo" height="200px" width="auto" />
        </div>
        <h1>{{ config('app.name', 'Laravel') }}</h2>

            <!-- Login Form -->
            <form action="{{route('user.register')}}" method="POST">
                @csrf
                <input type="text" id="login" class="fadeIn second" name="name" placeholder="نام" />
                ...
                <input type="text" id="login" class="fadeIn second" name="phone" placeholder="شماره تلفن" />
